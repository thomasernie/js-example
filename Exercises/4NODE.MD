...
=> Express is a server side or back end web framework for Node.js - A framework acts like a library(pre-defined modules a program can use), that provides a base 
   for an application.
